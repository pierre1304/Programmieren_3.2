...
-erhält immer Energie und vermehrt sich, wenn er frisst*/
class Cannibale extends Creature {
    constructor(x, y) {
        super(x, y);
        this.eatCount = 0;
        this.energy = 7;
...
-falls vollständig von Gras umringt, mutiert er zu einem Grasfresser
-falls mindestens zur Hälfte von Gras- oder Fleischfressern umringt, mutiert er zu einem Kannibalen*/

class Mutant extends Creature {
    constructor(x, y) {
        super(x, y);
        this.multiply = 0;
